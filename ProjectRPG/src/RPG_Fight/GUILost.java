...
public class GUILost extends javax.swing.JFrame
{
    public GUILost()
    {
        initComponents();
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(GUILost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
